...
<body>
    ...
    <div class="container">
        ...
        <form  role="form" action="submitparent.php" method='post'>
...
<div class="form-group col-md-12">
            ...
            <input class="form-control" type="text"  id="arsimi" name="arsimi" required>
            <div class="row">
            </div>
            <div class="row">
            <div class="form-group col-md-6">
            ...
            <input class="form-control" type="text"  id="profesioni" name="profesioni" required>
            </div>
            </div>
            <hr class="mb-3">
