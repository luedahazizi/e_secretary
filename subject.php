     ...
     if($conn ->query($subject)){
        ...
        echo "<div class='error'>Teacher don't exist</div>";
         ...
         ?>
            ...
            <input type="hidden" name="lendaID" value="<?php echo $lendaID; ?>">
                ...
                <input type="text" name="mesues" id="mesues" value="<?php echo $mesues; ?>" class="input1"><br>
                <input type="text" name="mesues1" id="mesues1" value="<?php echo $mesues; ?>" class="input1"><br>
        ...
        <div class="tbox">
            ...
            <table border="1px">
                ...
                <?php
                $lendet="select Emer,Emri,Mbiemer,Viti,LendaID FROM  lenda l join user u on l.MesuesID=u.userID";
