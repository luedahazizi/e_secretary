...
<h4>Here you can find publications and notifications that we post for activities,meetings,exams and more</h4></div>";
        ...
        while ($row = mysqli_fetch_array($result)) {
            $adresa = "http:\\bashkimi\\e_secretary\\uploads\\" . $row["attachments"];
            ...
            <a download href='" . $adresa . "' id='link'><img src='https://cdn.windowsreport.com/wp-content/uploads/2019/04/download-Windows-10-v1809-ISO-files.png'
